...
public class ParkingMain {
    public static void main(String[] args) throws InterruptedException {
        String nameOfParkingLot ="Harshit Parking Lot";
        Address address = new Address(null,null,"Bangalore","India","KA");
        ...
        ParkingFloor.Ticket ticket = parkingLot.assignTicket(vehicle);
